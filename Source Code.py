...
#set Title and geometry to window
window.title("Clock")
...
#alarm_stop_button = Button(alarm_tab, text='Stop', state='disabled',command=alarm)
#alarm_stop_button.pack(anchor='center')
